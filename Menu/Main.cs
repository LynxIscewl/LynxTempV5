    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            if (disconnectButton)
            {
                ...
                disconnectbutton.transform.localScale = new Vector3(0.095f, 0.37f, 0.105f);
                disconnectbutton.transform.localPosition = new Vector3(0.56f, 0.800f, 0.3f); 
                ...
                rectt.localPosition = new Vector3(0.064f, 0.240f, 0.12f); 
